...
| **10** | **Generative Modeling** | Evidence Lower Bound (ELBO) variational derivation, Reparameterization Trick, Wasserstein GAN Kantorovich-Rubinstein duality, DDPM/DDIM reverse diffusion Gaussian score matching, Optimal Transport Flow Matching (OT-CFM), Continuous Normalizing Flows (CNFs) & Rectified Flow (Re-Flow) | [Module 10](Projects/ai_math/10_generative_models) |
